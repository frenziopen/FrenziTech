...
/*
  ...
  */
  ...
  if (  tenMinDelay > 10) {
   ...
   String httpg_str = "AT+HTTPCGET=\"URL\",\"https://frenzitech.frenzivendi.com/sensor_service.php" + "\"\r\n";
AT+HTTPPARA="URL","https://frenzitech.frenzivendi.com/motor_service.php"
...
+HTTPACTION: 0,200,224
AT+HTTPREAD=224

OK

+HTTPREAD: DATA,224
{"motorStartTimeHr":"1","motorStartTimeMin":"12","motorRunTimeHr":"1","motorRunTimeMin":"1","motorRunInterval":"2","motorVoltage":"220","motorCurrent":"7","soilMoisturePercent":"1","soilTemperature":"1","airTemperature":"1"}
+HTTPREAD: 0
     sendData("AT+HTTPINIT\r\n", 2000, DEBUG);
    sendData(http_str, 2000, DEBUG);
    sendData("AT+HTTPACTION=0\r\n", 3000, DEBUG);
        sendData(httpg_str, 2000, DEBUG);
